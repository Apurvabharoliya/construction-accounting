...
CREATE TABLE parties (
  ...
  state VARCHAR(100),
  pin_code VARCHAR(10),
  party_type VARCHAR(20) CHECK (party_type IN ('supplier', 'beneficiary')),
...
CREATE TABLE beneficiaries (
  ...
  plinth DECIMAL(15,2) DEFAULT 0,
  lintel DECIMAL(15,2) DEFAULT 0,
  roof DECIMAL(15,2) DEFAULT 0,
  finishing DECIMAL(15,2) DEFAULT 0,

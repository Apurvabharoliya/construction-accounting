        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
            <div className="flex gap-4">
              {[...Array(6)].map((_, i) => <div key={i} className="h-3.5 flex-1 bg-gray-200 rounded animate-pulse" />)}
            </div>
          </div>
                  ...
                  return (
                    <tr key={party.id} className="border-t hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4 hidden md:table-cell">
                        {party.phone && <p className="text-sm flex items-center gap-1"><Phone className="w-3 h-3 text-gray-400" />{party.phone}</p>}
                      </td>

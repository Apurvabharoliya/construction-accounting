                          ...
                          {isExpanded && (
                            <div className="border-t border-blue-100 bg-blue-50/20">
                              ...
                              {party.invoices.map((inv) => (
                                <div key={inv.invoice_id} className="px-4 py-3 border-b border-blue-50 hover:bg-blue-50/50 transition-colors">
                                  {/* Mobile: card layout */}
                                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2 pl-8 sm:flex-nowrap">
                                    {/* Invoice Number */}
                                    <Link
                                      href={`/${inv.type === 'purchase' ? 'purchases' : 'sales'}/${inv.invoice_id}`}
                                      className="w-full sm:w-[170px] flex items-center gap-1.5 text-sm font-medium text-blue-600 hover:text-blue-700 shrink-0"
                                    >
                                    ...
                                    {/* Date */}
                                    <span className="w-full sm:w-[120px] shrink-0">
                                    ...
                                    {/* Type */}
                                    <span className={`w-auto sm:w-[80px] inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium shrink-0 ${
                                    ...
                                    {/* Total */}
                                    <span className="w-auto sm:w-[90px] text-sm font-medium text-gray-800 text-right shrink-0">{formatCurrency(inv.total_amount)}</span>

                                    {/* Progress */}
                                    <div className="w-full sm:w-[110px] shrink-0 order-last sm:order-none mt-1 sm:mt-0">
                                      <PaymentProgress paid={inv.amount_paid} total={inv.total_amount} />
                                    </div>

                                    {/* Paid */}
                                    <span className="w-auto sm:w-[90px] text-sm font-semibold text-green-600 text-right shrink-0">{formatCurrency(inv.amount_paid)}</span>

                                    {/* Balance Due */}
                                    <span className="w-auto sm:w-[100px] text-sm font-bold text-red-600 text-right shrink-0">{formatCurrency(inv.balance_due)}</span>

                                    {/* Last Payment Date */}
                                    <span className="w-auto sm:w-[100px] text-sm text-center shrink-0">
                                    ...
                                    {/* Status */}
                                    <div className="w-auto sm:w-[70px] text-center shrink-0">
                              ...
                              <div className="px-4 py-3 bg-blue-50/50 border-t border-blue-100">
                                <div className="flex flex-wrap items-center gap-x-3 pl-8">
                                  <span className="w-full sm:w-[170px] text-xs font-semibold text-gray-600">Party Total</span>
                                  ...
                                  <span className="w-[100px] text-right text-xs font-bold text-red-700">
